      ...
      <div className='cards'>
        <div className='card'>
          <div className='data'>
            ...
            <img
              src='/images/cakes/frozen.png'
              alt='product img'
              className='toshow'
            />
          </div>
          <a href='#' className='name'>
            Frozen Theme Elsa Photo print cake
          </a>
          <h3>&#x20b9;1250</h3>
        </div>
        <div className='card'>
          <div className='data'>
            ...
            <img
              src='/images/cakes/Chocolate.jpg'
              alt='product img'
              className='toshow'
            />
          </div>
        ...
        <div className='card'>
          <div className='data'>
            ...
            <img
              src='/images/cakes/mick2.jpg'
              alt='product img'
              className='toshow'
            />
          </div>
          <a href='#' className='name'>
            Two Tier Micky Theme Cake
          </a>
          <h3>&#x20b9;2610</h3>
        </div>
        <div className='card'>
        ...
        <div className='card'>
          <div className='data'>
            ...
            <img
              src='/images/cakes/Ronaldo.jpg'
              alt='product img'
              className='toshow'
            />
          </div>
          <a href='#' className='name'>
            Ronaldo-football-theme-cake
          </a>
          <h3>&#x20b9;1350</h3>
        </div>
        <div className='card'>
